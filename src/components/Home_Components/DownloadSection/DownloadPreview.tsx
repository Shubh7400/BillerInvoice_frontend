        ...
        <div className="absolute inset-0 p-8 pt-20 flex flex-col">
          ...
          <div className="flex justify-between my-4 ">
            <div className="text-black">
              <h1 className="text-[20px] flex items-center h-[30px] mt-[-10px] text-white bg-[#94b9ff] w-[300px] rounded pb-[20px] pl-2 ">Billing From</h1>
            ...
            <div className="text-black">
              <h1 className="text-[20px] flex items-center h-[30px] mt-[-10px] text-white bg-[#94b9ff] w-[300px] rounded pb-[20px] pl-2 ">Bill To</h1>
              <h3 className="text-sm font-bold p-[3px]">{clientObj.clientName}</h3>
              <p className="text-xs p-[3px] text-[15px]">
              ...
              <p className="text-xs opacity-70 p-[3px] text-[15px]">
                ...
                <br />
                {clientObj.address?.city}, {clientObj.address?.state} {clientObj.address?.postalCode} - {clientObj.address?.country}
              </p>
            </div>
          </div>
          {/* Table section */}
          <table className="w-full my-4 text-sm rounded-[20px]" style={{
            borderRadius: "20px"
          }}>
          ...
          <div className="flex justify-between mt-4">
            ...
            <h1 className="text-[20px] flex items-center h-[30px] mt-[-10px] text-white bg-[#94b9ff] w-[300px] rounded pb-[20px] pl-2 ">Payment info</h1>
            ...
            <div className="text-sm w-[300px]">
              ...
              {clientObj.sameState ? (
                <>
                  <div className="flex justify-between">SGST @ 9%: <span>{taxAmount / 2}</span></div>
                  <div className="flex justify-between">CGST @ 9%: <span>{taxAmount / 2}</span></div>
                </>
              ) : (
                <div className="flex justify-between mb-[30px]">IGST @ 18%: <span>{taxAmount}</span></div>
              )}
